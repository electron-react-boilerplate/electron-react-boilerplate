// flow-typed signature: 67d556e445814cadd95c693c62b4b177
// flow-typed version: <<STUB>>/electron-builder_v^8.6.0/flow_v0.36.0
...
declare module 'electron-builder/out/build-cli' {
  declare module.exports: any;
}
...
declare module 'electron-builder/out/cleanup' {
  declare module.exports: any;
}
...
declare module 'electron-builder/out/install-app-deps' {
  declare module.exports: any;
}
...
declare module 'electron-builder/out/node-gyp-rebuild' {
  declare module.exports: any;
}
...
declare module 'electron-builder/out/build-cli.js' {
  declare module.exports: $Exports<'electron-builder/out/build-cli'>;
}
declare module 'electron-builder/out/builder.js' {
  declare module.exports: $Exports<'electron-builder/out/builder'>;
}
declare module 'electron-builder/out/cleanup.js' {
  declare module.exports: $Exports<'electron-builder/out/cleanup'>;
}
declare module 'electron-builder/out/cliOptions.js' {
  declare module.exports: $Exports<'electron-builder/out/cliOptions'>;
}
...
declare module 'electron-builder/out/install-app-deps.js' {
  declare module.exports: $Exports<'electron-builder/out/install-app-deps'>;
}
...
declare module 'electron-builder/out/node-gyp-rebuild.js' {
  declare module.exports: $Exports<'electron-builder/out/node-gyp-rebuild'>;
}
